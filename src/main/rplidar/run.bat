...
scp RPLidar.class RPLidarDriver.class DeviceInfo.class DeviceHealth.class Measurement.class PositionTracker.class librplidar.so data.txt run.sh %host%:/home/pi/Documents/GRTLidar/ 
if %errorlevel% neq 0 exit /b %errorlevel%
